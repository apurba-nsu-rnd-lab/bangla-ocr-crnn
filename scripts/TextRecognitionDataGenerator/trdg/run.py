...
def parse_arguments():
    ...
    parser.add_argument(
        ...
        type=int,
        nargs="?",
        help="Define the starting number index for image generation",
        default=0,
    )
    parser.add_argument(
        "-i",
...
def main():
    ...
    for _ in tqdm(
        p.imap_unordered(
            ...
            zip(
                [i for i in range(args.start_index, string_count+args.start_index)],
                strings,
                [fonts[rnd.randrange(0, fonts_count)] for _ in range(0, string_count)],
                [args.output_dir] * string_count,
                # [args.format] * string_count,
                [args.format[rnd.randrange(0, format_count)] for _ in range(0, string_count)],
